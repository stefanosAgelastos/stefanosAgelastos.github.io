        ...
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a(function (resolve, reject) {
              ...
              var response = fetch(selected.markdownUrl);

              if (!response.ok) {
                return _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a.reject(new Error(response.statusText));
              }
            }));
...
//# sourceMappingURL=projects.js.dbbf7cf8f1fe78987a4e.hot-update.js.map