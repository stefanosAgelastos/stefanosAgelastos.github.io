      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a.reject(new Error("No project matches the slug")));

          case 3:
            _context.next = 5;
            return fetch(selected.markdownUrl);
          ...
          case 5:
            ...
            return _context.abrupt("return", _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a.reject(new Error(response.statusText)));

          case 8:
            consolo.log(response.text);
            return _context.abrupt("return", new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a(response.text));
...
//# sourceMappingURL=projects.js.71e55df57110135295c4.hot-update.js.map